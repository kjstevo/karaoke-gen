...
def create_parser(prog: str = "karaoke-gen") -> argparse.ArgumentParser:
    ...
    finalise_group.add_argument(
        ...
        help="Optional: Output only a single 720p MP4 with lossless FLAC audio, skipping the 4K lossless/lossy MP4, lossless MKV, and lossy 720p MP4. Can also be set via the MAKE1VIDEO=true environment variable. Example: --make1video",
    )
    finalise_group.add_argument(
        "--brand_prefix",
